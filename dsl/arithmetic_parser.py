...
parser = yacc.yacc(tabmodule="parser.autogen_arithmetic_parsetab", outputdir=here, debug=0)
expression_parser = yacc.yacc(tabmodule="parser.autogen_arithexpr_parsetab", start="term", 
                              outputdir=here, debug=0)
